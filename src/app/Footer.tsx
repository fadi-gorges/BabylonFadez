...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-800 text-neutral-content">
            <div>
                <Image src="/logoTransparent.png" alt="Logo" width={100} height={100}/>
                <p className="font-bold">
                    Babylon Fadez. <br/>Serving fresh cuts.
                </p>
